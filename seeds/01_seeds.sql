...
-- INSERT INTO properties (owner_id, title, description,thumbnail_photo_url,cost_per_night,
-- parking_spaces,number_of_bathrooms,number_of_bedrooms)
-- VALUES (1,'Townhouse','/dossier','/folder/file',250,1,2,3),
-- (2,'Townhouse','/dossier','/folder/file',250,1,2,3),
-- (3,'Townhouse','/dossier','/folder/file',250,1,2,3);
